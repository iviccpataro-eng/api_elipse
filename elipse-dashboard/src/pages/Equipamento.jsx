            ...
            <div className="max-w-6xl mx-auto">
                ...
                {variaveis.length > 0 ? (
                    <>
                        ...
                        {layoutMode === "detailed" && (
                            <div className="bg-white rounded-xl shadow animate-fadeIn">
                                <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-3 smpx-4 py-2 bg-gray-100 text-gray-700 font-semibold text-sm border-b">
                                    <div>Nome</div>
                                ...
                                {variaveis.map((v, i) => (
                                    <div
                                        key={i}
                                        className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-3 px-4 py-3 text-sm hover:bg-gray-50 border-b last:border-none"
                                    >
